document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadBlogs() {
        try {
            const response = await axios.get('https://vperegrina-19ae04c9ecc1.herokuapp.com/blogposts');
    ...
    function createBlogRow(blog) {
        ...
        editButton.addEventListener('click', async () => {
            ...
            try {
                const response = await axios.put(`https://vperegrina-19ae04c9ecc1.herokuapp.com/blogposts/${blog.id}`, {
                    title: blog.title,
