...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/replica/get-all')
...
fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/pilgrimage/get-all')
  .then(response => response.json())
  .then(data => {
    if (data.error) {
...
function handleFormSubmit() {
  ...
  document.getElementById('imageForm').addEventListener('submit', function(event) {
      ...
      fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/replica/create', {
          method: 'POST',
          headers: {
...
function handleFormSubmit() {
  ...
  document.getElementById('pilgrimageForm').addEventListener('submit', function(event) {
    ...
    // Realizar la petición fetch para enviar los datos al backend
    fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/pilgrimage/create', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function loadContactDetails() {
      fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/contacts/1')
          .then(response => response.json())
          .then(data => {
              const contactHtml = `
                  <div class="col-md-6">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  fetch('https://vperegrina-19ae04c9ecc1.herokuapp.com/blogposts') // Cambia la URL a la que corresponda para obtener tus posts
    .then(response => response.json())
    .then(posts => {
