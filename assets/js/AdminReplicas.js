document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadReplicas() {
        try {
            const response = await axios.get('https://vperegrina-19ae04c9ecc1.herokuapp.com/replica/get-all');
    ...
    createReplicaForm.addEventListener('submit', async function (event) {
        ...
        try {
            const response = await axios.post('https://vperegrina-19ae04c9ecc1.herokuapp.com/replica/create', replicaData);
